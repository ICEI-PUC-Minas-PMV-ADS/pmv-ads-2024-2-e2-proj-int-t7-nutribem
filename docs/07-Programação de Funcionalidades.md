...
|RF-002| Cadastrar um paciente como usuário, com informações pessoais em geral, objetivos e dados ligados a sua saúde (altura, idade, etc.). | Em andamento |Guilherme|
|RF-003| Realizar login utilizando CPF e senha. | Tela de login com senha incriptada |Guilherme, Karina e Victor|
|RF-004| Cadastrar um plano alimentar pelo nutricionista e utiliza CRUD's para o seu gerenciamento.|Crud completo|Joel|
|RF-005| O paciente Registra o diário alimentar com informações sobre horário das refeições, calorias ingeridas, ingredientes consumidos, etc por meio de um campo Editável.|Crud completo|Ana|
|RF-006| Propor dicas de receitas por nutricionistas e pacientes e utiliza CRUD's para o seu gerenciamento.| Crud completo|Ana|
|RF-007| Avaliar as receitas propostas (like ou joinha). |Like|Karina|
|RF-008| Permitir que tanto o paciente quanto o nutricionista alterem seus dados de cadastro.|Tela de edição de cadastro|Guilherme|
<br>
...
<br> <p align="center">
**Exemplo da Inicio, menu lateral:**
<br>
<br>
<img src= "https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-2-e2-proj-int-t7-nutribem/blob/4661778aed0799f87342ac7a2c8649dabf81fb70/docs/img/Tela%20efetiva%20inicial%20criar%20usuario.jpeg">
<br> <p align="center">
...
### RF-002-Cadastrar um paciente como usuário, com informações pessoais em geral, objetivos e dados ligados a sua saúde (altura, idade, etc.)
O acesso a criação do paciente deve ser realizado pelo menu lateral clica em "Criar conta como paciente", após ser direcionado a nova página deve ser preenchido dados solicitados e assim que completo o cadastro clicar em "Salvar".
<br>
...
### RF-003-Realizar login utilizando CPF e senha.
...
### RF-004-Cadastrar um plano alimentar pelo nutricionista e utiliza CRUD's para o seu gerenciamento.
...
### RF-005-O paciente Registra o diário alimentar com informações sobre horário das refeições, calorias ingeridas, ingredientes consumidos, etc por meio de um campo Editável.
...
### RF-006-Propor dicas de receitas por nutricionistas e pacientes e utiliza CRUD's para o seu gerenciamento e RF-007-Avaliar as receitas propostas (like ou joinha). 
...
### RF-008-Permitir que tanto o paciente quanto o nutricionista alterem seus dados de cadastro.
O acesso para editar o cadastro é realizado pelos usuários após realizarem o login, deve clicar no ícone "Meu perfil" e/ou menu lateral clica em "Meu perfil" para usuário nutricionista e pacientes, será direcionado a nova página, deve clicar em "Editar meu perfil", alterar o dado que deseja e após em clicar "Salvar".<br>
...
<br> <p align="center">
**Exemplo da tela Meu perfil:**
<br>
<br>
<img src= "https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-2-e2-proj-int-t7-nutribem/blob/2e1cf1af2bfdb79157127f4164cd5fe8c066fcf0/docs/img/Tela%20efetiva%20meu%20perfil.png">
<br> <p align="center">
